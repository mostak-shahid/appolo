...
$title = $appolo_options['sections-widgets-title'];
$content = $appolo_options['sections-widgets-content'];
$widget_layout = $appolo_options['sections-widgets-layout'];
...
?>
<section id="section-widgets" <?php if(@$appolo_options['sections-widgets-background-type'] == 1) echo 'class="'.@$appolo_options['sections-widgets-background'].'"';?>>
