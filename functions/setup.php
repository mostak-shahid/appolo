<?php
//Add theme setup
if ( ! function_exists( 'appolo_setup' ) ) :
	function appolo_setup() {
		...
		register_nav_menus( array(
			'mainmenu' => __('Main Menu', 'appolo'),
			'mobilemenu' => __('Mobile Menu', 'appolo'),
		));
...
add_action( 'after_setup_theme', 'appolo_setup' );